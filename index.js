...
const nameBand = 'CODE-FI';

const nameSongs = [
	"BURNT TOAST - JUSTNORMAL", /*1*/
	"SHOKAWA - SINY", /*2*/
	"DUST BLASTER - JOBII", /*3*/
	"COMPUTE - OSOKU", /*4*/
	"NEOPOLITIN - GUUSTAVV", /*5*/
	"THE WRITER - SMARTFACE", /*6*/
	"NAMI - OSOKU", /*7*/
	"POMELO - JOBII", /*8*/
	"I PLAY COLORS - JUSTNORMAL", /*9*/
	"POCKET ACES", /*10*/
	"MOLN - OSOKU", /*11*/
	"STILL TRYING FOR YOU - GUSTAV GILLE", /*12*/
	"THICK AND THIN - GUUSTAVV", /*13*/
	"RAINY SUNDAY - HENYAO", /*14*/
	"THE ILLSTRUMENTALIST - NOCTURNAL JAM", /*15*/
	"TOO TIRED - SMARTFACE", /*16*/
	"SUMMER RAIN  - OCEAN JAMS", /*17*/
	"VAPOUR - OSOKU", /*18*/
	"SEASIDE SWING - GUUSTAVV", /*19*/
	"DYLAN SITTS - THE AFTERMATH", /*20*/
]
